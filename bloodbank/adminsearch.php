...
<body>
    ...
    <div class="container">
        <div class="col-lg-12">
        <h1 class="searchhead"> SEARCH FOR BLOOD</h1>
          <div class="spl">
              <form action="bloodsearch.php" method="POST">
                  <div class="form-group">
                        <i class="fas fa-search"></i>
                        <label for="typesearch" id="searchhead">Search BY Blood Type</label>
                        <select class="form-control" name="bloodtype" id="typesearch">
          ...
          <h1 class="searchhead">DONOR DETAILS</h1>
 <?php
